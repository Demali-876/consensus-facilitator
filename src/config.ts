...
export const ASSETS: Record<string, AssetConfig> = {
  'ryjl3-tyaaa-aaaaa-aaaba-cai': {
    ...
    decimals: 8, ledgerId: 'ryjl3-tyaaa-aaaaa-aaaba-cai', transferFee: 10_000n,
  },
  'xevnm-gaaaa-aaaar-qafnq-cai': {
    symbol: 'ckUSDC', name: 'Chain-key USDC',
    decimals: 6, ledgerId: 'xevnm-gaaaa-aaaar-qafnq-cai', transferFee: 10_000n,
  },
  'cngnf-vqaaa-aaaar-qag4q-cai': {
    symbol: 'ckUSDT', name: 'Chain-key USDT',
    decimals: 6, ledgerId: 'cngnf-vqaaa-aaaar-qag4q-cai', transferFee: 10_000n,
  },
  // Testnet tokens (faucet.internetcomputer.org — Oisy: Test networks → IC)
  'xafvr-biaaa-aaaai-aql5q-cai': {
    symbol: 'TESTICP', name: 'Test ICP',
    decimals: 8, ledgerId: 'xafvr-biaaa-aaaai-aql5q-cai', transferFee: 10_000n,
  },
  '3jkp5-oyaaa-aaaaj-azwqa-cai': {
    symbol: 'TICRC1', name: 'Test ICRC-1',
    decimals: 8, ledgerId: '3jkp5-oyaaa-aaaaj-azwqa-cai', transferFee: 10_000n,
  },
}
